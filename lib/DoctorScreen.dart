...
class _DoctorScreenState extends State<DoctorScreen> {
  ...
  void initState() {
    ...
    fetchAllData(); // Fetch all data during initialization
  }

  // Fetch all data and update the state
  ...
  List<BarChartGroupData> generateBarGroups(List<InOutPatientData> data) {
    ...
    // Update day data map with actual values
...
// A reusable widget for displaying doctor panel information
